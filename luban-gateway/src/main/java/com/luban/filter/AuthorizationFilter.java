...
import com.luban.common.exception.GateWayException;
import com.luban.properties.NotAuthUrlProperties;
import com.luban.utils.JwtUtils;
...
public class AuthorizationFilter implements GlobalFilter,Ordered,InitializingBean {
    ...
    @Autowired
    private LubanRestTemplate restTemplate;
